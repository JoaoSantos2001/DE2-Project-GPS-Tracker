...
def parse_gps_data(my_gps):
    ...
    return {
        ...
        'speed': my_gps.speed_string(),  # Speed in kilometers per hour
        'satellites': str(my_gps.satellites_in_use),  # Number of satellites in use
        'pdop': str(my_gps.pdop),  # Position Dilution of Precision
        'hdop': str(my_gps.hdop),  # Horizontal Dilution of Precision
        'vdop': str(my_gps.vdop),  # Vertical Dilution of Precision
    }
